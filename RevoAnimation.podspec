...
Pod::Spec.new do |spec|
  ...
  spec.name         = "RevoAnimation"
  spec.version      = "0.0.1"
  spec.summary      = "Swift Animation helpers."
  ...
  spec.description  = "A nice set of helpers to easily work with animations and swift"
  ...
  spec.source       = { :git => "https://github.com/revosystems/revoanimation.git", :tag => "0.0.1" }
  ...
  spec.source_files  = "RevoAnimation/src/**/*.{swift}"#, "src/**/*.{h,m}"
